                        ...
                        <View>
                            ...
                            <View>
                                ...
                                <List.Item
                                    ...
                                    left={props => <List.Icon {...props} icon="account-circle" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/>}
                                    right={props => <TouchableOpacity onPress={() => this.handleDialog(0)}><List.Icon {...props} icon="pencil" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/></TouchableOpacity>}
                               ...
                               <View style = {styles.separator} />
                                ...
                                <List.Item
                                    ...
                                    left={props => <List.Icon {...props} icon="account-circle" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/>}
                                    right={props => <TouchableOpacity onPress={() => this.handleDialog(1)}><List.Icon {...props} icon="pencil" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/></TouchableOpacity>}
                                    style={{alignItems: 'center'}}
                                />
                                ...
                                <List.Item
                                    ...
                                    description={gender}
                                    descriptionStyle={{color:"#ffffff",fontSize: 20}}
                                    left={props => <List.Icon {...props} icon="gender-male-female" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}} />}
                                    right={props => <TouchableOpacity onPress={() => this.handleDialog(4)}><List.Icon {...props} icon="pencil" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/></TouchableOpacity>}
                                    style={{alignItems: 'center'}}
                                />
                               ...
                               <View style = {styles.separator} />
                                ...
                                <List.Item
                                    ...
                                    description={height}
                                    descriptionStyle={{color:"#ffffff",fontSize: 20}}
                                    left={props => <List.Icon {...props} icon="human-male-height" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/>}
                                    right={props => <TouchableOpacity onPress={() => this.handleDialog(2)}><List.Icon {...props} icon="pencil" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/></TouchableOpacity>}
                                    style={{alignItems: 'center'}}
                                />
                               ...
                               <View style = {styles.separator} />
                                ...
                                <List.Item
                                    ...
                                    description={weight}
                                    descriptionStyle={{color:"#ffffff",fontSize: 20}}
                                    left={props => <List.Icon {...props} icon="weight-pound" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}}/>}
                                    right={props => <TouchableOpacity onPress={() => this.handleDialog(3)}><List.Icon {...props} icon="pencil" style={{backgroundColor: '#71ceac', borderRadius: 85,
                                        borderWidth: 5}} /></TouchableOpacity>}
                                    style={{alignItems: 'center'}}
                                />
                                <View style = {styles.separator} />
